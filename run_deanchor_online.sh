...
env -u CARDAWARE_SEARCH -u CARDAWARE_WORLDS -u POSTACTION_VALUE \
    ...
    BELIEF_CKPT="/Users/shukaihu/Code_Project_Local/AlphaBig2-claude/ppo/checkpoints/belief_hist_sc4500_best.pt" \
    ...
    ./.venv/bin/python3 run_online_leg.py \
        ...
        --ckpt "/Users/shukaihu/Code_Project_Local/AlphaBig2-claude/ppo/checkpoints/policy_4500_best.pt" \
        --goal 300 --already 0
